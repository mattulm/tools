...
for type in A AAAA CNAME CERT DLV DNSKEY HINFO IPSECKEY MX NS NSEC PTR RP SIG SOA SRV TXT; do
	...
	echo " "; sleep 2; echo " " >> /home/$1.digs.list;
done
